odoo.define('pos_margin.PaymentSuperate', function(require) {
    'use strict';
    ...
    class PaymentSuperate extends PosComponent {
           constructor() {
                ...
                this.selectClients = this.env.pos.db.get_partner_by_id(this.pos.config.default_partner_id[0]);
           ...
           onClickSuperate() {
              try{
                ...
                this.set_client(this.selectClients);
