odoo.define('pos_margin.ProductItemSearch', function(require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class ProductItemSearch extends PosComponent {
        /**
    ...
    ProductItemSearch.template = 'ProductItemSearch';

    Registries.Component.add(ProductItemSearch);
