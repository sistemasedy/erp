odoo.define('pos_margin.ProductsWidgetSearch', function(require) {
    'use strict';
    ...
    class ProductsWidgetSearch extends PosComponent {
        /**
         * @param {Object} props
        ...
        get productsToDisplay2() {
            ...
            if (this.searchWord !== '') {
                products = this.env.pos.db.search_product_in_category(this.selectedCategoryId,this.searchWord);
            } else {
    ...
    ProductsWidgetSearch.template = 'ProductsWidgetSearch';

    Registries.Component.add(ProductsWidgetSearch);

    return ProductsWidgetSearch;
});
