odoo.define('web_sitets.ap', function(require) {
    'use strict';
    ...
    const PosComponent = require('web_sitets.PosComponent');
    const PopupControllerMixin = require('web_sitets.PopupControllerMixin');
    const Registries = require('web_sitets.Registries');
    ...
    class Chrome extends PopupControllerMixin(PosComponent) {
        ...
        get startScreen() {
            if (this.state.uiState !== 'READY') {
                ...
                alert("esto es lo que que esta pasando state no ready")
            }
