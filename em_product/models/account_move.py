...
class AccountMoveLine(models.Model):
    ...
    monto = fields.Float(string='Monto',  compute='_compute_monto', digits=(2, 2), store=True)
    itbis = fields.Float(string='Itbis',  compute='_compute_itbis',digits=(2, 2), store=True)
