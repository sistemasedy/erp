odoo.define('point_of_sale.ListProducts', function(require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class ListProducts extends PosComponent {
        /**
    ...
    ListProducts.template = 'ListProducts';

    Registries.Component.add(ListProducts);
